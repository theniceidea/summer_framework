package com.fmk.framework.sftp;
...
public class SftpUtil {
    ...
    private static final com.fmk.framework.logger.Logger log = Logger.getLogger("regulatorreport");
     ...
     */
    public void login(){
        log.info( username+"-----"+privateKey+"-------"+password+"---------"+host+"----------"+port);
        try {
            JSch jsch = new JSch();
//            privateKey=null;
//            if (privateKey != null) {
