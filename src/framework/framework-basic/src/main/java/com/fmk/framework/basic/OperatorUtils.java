...
public class OperatorUtils {
    private static String CMCC = "2";//"移动";
    private static String UNICOM = "1";//"联通";
    private static String TELECOM = "3";//"电信";
    private static String UNKNOWN = "4";//"未知";
...
//       System.out.print(execute("18917590806"));
//    }
}