...
public class HttpClientUtils {
	...
	private static void request(HttpUriRequest request, OnStatusLine onStatusLine, OnResponse onResponse) {
...
//			IOUtils.closeQuietly(httpclient);
	...
	private static String responseEntityToString(HttpEntity entity, String charset){
		try {
	...
	private static byte[] responseEntityToByteArray(HttpEntity entity){
		try {
	...
	public static GetRequest request(GetRequest req){
	...
	public static DeleteRequest request(DeleteRequest req){
	...
	public static DownloadRequest request(DownloadRequest req){
		HttpGet httpGet = new HttpGet(req.buildUrl());
		try {
			httpGet.setConfig(commonRequestConfig);
			RequestResultStatus status = new RequestResultStatus();
	...
	public static PostFormRequest request(PostFormRequest req){
    ...
    public static PostPBRequest request(PostPBRequest req){
        HttpPost httpPost = new HttpPost(req.buildUrl());
        httpPost.setConfig(commonRequestConfig);
...
//            httpPost.setEntity(new GzipCompressingEntity(bae));
	...
	public static PutFormRequest request(PutFormRequest req){
	...
	public static PostStringRequest request(PostStringRequest req){
		HttpPost httpPost = new HttpPost(req.buildUrl());
		httpPost.setConfig(commonRequestConfig);
...
//			}
    ...
    public static PutStringRequest request(PutStringRequest req){
        HttpPut httpPut = new HttpPut(req.buildUrl());
        httpPut.setConfig(commonRequestConfig);
...
//			}
	...
	public static PostFileRequest request(PostFileRequest req){
		HttpPost httpPost = new HttpPost(req.buildUrl());
		httpPost.setConfig(commonRequestConfig);
