...
* demotable3
*/
public interface IDemotable3List extends List<Demotable3>{
    /**
    * id
    */
    List<Integer> idList();
    ...
    * demotable2
    */
    List<Integer> demotable2IdList();
    /**
    * demotable2
    */
    List<Integer> demotable2IdList_skipNull();
    /**
    * demotable2
    */
    IDemotable2List demotable2IdEntityList();
    /**
    * delete status
    */
    ...
    * 创建时间2
    */
    List<Timestamp> creationDate2List();
    /**
    * 创建时间2
    */
    List<Timestamp> creationDate2List_skipNull();
}
